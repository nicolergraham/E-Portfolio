...
![Map of spawning and rearing streams from bcfishpass](images/modobs_streams.png){fig-align="left"}
...
GEM 510/511
![Performed a least cost path analysis on Grizzly Bears in Alberta using vectors and rasters using OSGeo4W shell, QGIS and ArcGISPro](images/Map.png){fig-align="left"}


![Utilized hydrology, network analyst and linear referencing tools in ArcGIS Pro to model a salmon stream network. This figure shows the reachable and not reachable streams for the Georgia Strait Chinook conservation unit inlcuing the presence of dams](images/reachable_streams.png){fig-align="left"}
